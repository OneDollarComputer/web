...
(One Dollar Computer V1 is single-side assembly – all SMD on top.)
...
1. [Download the design files from GitHub](https://github.com/OneDollarComputer/web/tree/main/download)
