...
${G}`,[le,G]}function Df(s){for(var a=s.length-2,u=s.length-1;u>=2&&s[u].optional;--u)a--;return a}function Ts(s,a,u,f,g,M){var T=a.length;T<2&&vt("argTypes array size mismatch! Must at least get return value and 'this' types!"),L(!M,"Async bindings are only supported with JSPI.");for(var C=a[1]!==null&&u!==null,U=Rl(a),G=a[0].name!=="void",te=T-2,le=Df(a),ge=[s,vt,f,g,Qo,a[0],a[1]],ue=0;ue<T-2;++ue)ge.push(a[ue+2]);if(!U)for(var ue=C?1:2;ue<a.length;++ue)a[ue].destructorFunction!==null&&ge.push(a[ue].destructorFunction);ge.push(Rf,le,te);let[ye,qe]=Pf(a,C,G,M);var mt=new Function(...ye,qe)(...ge);return Ss(s,mt)}var As=(s,a)=>{for(var u=[],f=0;f<s;f++)u.push(Me[a+f*4>>2]);return u},ea=s=>{s=s.trim();const a=s.indexOf("(");return a===-1?s:(L(s.endsWith(")"),"Parentheses for argument names should match."),s.slice(0,a))},Lf=(s,a,u,f,g,M,T,C,U)=>{var G=As(u,f);a=Bt(a),a=ea(a),M=Bn(g,M,C),Rn([],[s],te=>{te=te[0];var le=`${te.name}.${a}`;function ge(){Ci(`Cannot call ${le} due to unbound types`,G)}a.startsWith("@@")&&(a=Symbol[a.substring(2)]);var ue=te.registeredClass.constructor;return ue[a]===void 0?(ge.argCount=u-1,ue[a]=ge):(Ko(ue,a,le),ue[a].overloadTable[u-1]=ge),Rn([],G,ye=>{var qe=[ye[0],null].concat(ye.slice(1)),mt=Ts(le,qe,null,M,T,C);if(ue[a].overloadTable===void 0?(mt.argCount=u-1,ue[a]=mt):ue[a].overloadTable[u-1]=mt,te.registeredClass.__derivedClasses)for(const lt of te.registeredClass.__derivedClasses)lt.constructor.hasOwnProperty(a)||(lt.constructor[a]=mt);return[]}),[]})},If=(s,a,u,f,g,M)=>{L(a>0);var T=As(a,u);g=Bn(f,g),Rn([],[s],C=>{C=C[0];var U=`constructor ${C.name}`;if(C.registeredClass.constructor_body===void 0&&(C.registeredClass.constructor_body=[]),C.registeredClass.constructor_body[a-1]!==void 0)throw new kr(`Cannot register multiple constructors with identical number of parameters (${a-1}) for class '${C.name}'! Overload resolution is currently only performed using the parameter count, not actual type info!`);return C.registeredClass.constructor_body[a-1]=()=>{Ci(`Cannot construct ${C.name} due to unbound types`,T)},Rn([],T,G=>(G.splice(1,0,null),C.registeredClass.constructor_body[a-1]=Ts(U,G,null,g,M),[])),[]})},Nf=(s,a,u,f,g,M,T,C,U,G)=>{var te=As(u,f);a=Bt(a),a=ea(a),M=Bn(g,M,U),Rn([],[s],le=>{le=le[0];var ge=`${le.name}.${a}`;a.startsWith("@@")&&(a=Symbol[a.substring(2)]),C&&le.registeredClass.pureVirtualFunctions.push(a);function ue(){Ci(`Cannot call ${ge} due to unbound types`,te)}var ye=le.registeredClass.instancePrototype,qe=ye[a];return qe===void 0||qe.overloadTable===void 0&&qe.className!==le.name&&qe.argCount===u-2?(ue.argCount=u-2,ue.className=le.name,ye[a]=ue):(Ko(ye,a,ge),ye[a].overloadTable[u-2]=ue),Rn([],te,mt=>{var lt=Ts(ge,mt,le,M,T,U);return ye[a].overloadTable===void 0?(lt.argCount=u-2,ye[a]=lt):ye[a].overloadTable[u-2]=lt,[]}),[]})},Pl=(s,a,u)=>(s instanceof Object||vt(`${u} with invalid "this": ${s}`),s instanceof a.registeredClass.constructor||vt(`${u} incompatible with "this" of type ${s.constructor.name}`),s.$$.ptr||vt(`cannot call emscripten binding method ${u} on deleted object`),Ms(s.$$.ptr,s.$$.ptrType.registeredClass,a.registeredClass)),Ff=(s,a,u,f,g,M,T,C,U,G)=>{a=Bt(a),g=Bn(f,g),Rn([],[s],te=>{te=te[0];var le=`${te.name}.${a}`,ge={get(){Ci(`Cannot access ${le} due to unbound types`,[u,T])},enumerable:!0,configurable:!0};return U?ge.set=()=>Ci(`Cannot access ${le} due to unbound types`,[u,T]):ge.set=ue=>vt(le+" is a read-only property"),Object.defineProperty(te.registeredClass.instancePrototype,a,ge),Rn([],U?[u,T]:[u],ue=>{var ye=ue[0],qe={get(){var lt=Pl(this,te,le+" getter");return ye.fromWireType(g(M,lt))},enumerable:!0};if(U){U=Bn(C,U);var mt=ue[1];qe.set=function(lt){var Dt=Pl(this,te,le+" setter"),xt=[];U(G,Dt,mt.toWireType(xt,lt)),Qo(xt)}}return Object.defineProperty(te.registeredClass.instancePrototype,a,qe),[]}),[]})},Uf=(s,a,u)=>{s=Bt(s),Rn([],[a],f=>(f=f[0],t[s]=f.fromWireType(u),[]))},Dl=[],zn=[0,1,,1,null,1,!0,1,!1,1],ta=s=>{s>9&&--zn[s+1]===0&&(L(zn[s]!==void 0,"Decref for unallocated handle."),zn[s]=void 0,Dl.push(s))},zt={toValue:s=>(s||vt(`Cannot use deleted val. handle = ${s}`),L(s===2||zn[s]!==void 0&&s%2===0,`invalid handle: ${s}`),zn[s]),toHandle:s=>{switch(s){case void 0:return 2;case null:return 4;case!0:return 6;case!1:return 8;default:{const a=Dl.pop()||zn.length;return zn[a]=s,zn[a+1]=1,a}}}},Ll={name:"emscripten::val",fromWireType:s=>{var a=zt.toValue(s);return ta(s),a},toWireType:(s,a)=>zt.toHandle(a),argPackAdvance:kn,readValueFromPointer:Es,destructorFunction:null},Il=s=>xn(s,Ll),Of=(s,a,u)=>{switch(a){case 1:return u?function(f){return this.fromWireType(oe[f])}:function(f){return this.fromWireType(ve[f])};case 2:return u?function(f){return this.fromWireType(Ue[f>>1])}:function(f){return this.fromWireType(be[f>>1])};case 4:return u?function(f){return this.fromWireType(pe[f>>2])}:function(f){return this.fromWireType(Me[f>>2])};default:throw new TypeError(`invalid integer width (${a}): ${s}`)}},kf=(s,a,u,f)=>{a=Bt(a);function g(){}g.values={},xn(s,{name:a,constructor:g,fromWireType:function(M){return this.constructor.values[M]},toWireType:(M,T)=>T.value,argPackAdvance:kn,readValueFromPointer:Of(a,u,f),destructorFunction:null}),Jo(a,g)},Cs=(s,a)=>{var u=Ti[s];return u===void 0&&vt(`${a} has unknown type ${Cl(s)}`),u},Bf=(s,a,u)=>{var f=Cs(s,"enum");a=Bt(a);var g=f.constructor,M=Object.create(f.constructor.prototype,{value:{value:u},constructor:{value:Ss(`${f.name}_${a}`,function(){})}});g.values[u]=M,g[a]=M},zf=(s,a)=>{switch(a){case 4:return function(u){return this.fromWireType(Je[u>>2])};case 8:return function(u){return this.fromWireType(ct[u>>3])};default:throw new TypeError(`invalid float width (${a}): ${s}`)}},Hf=(s,a,u)=>{a=Bt(a),xn(s,{name:a,fromWireType:f=>f,toWireType:(f,g)=>{if(typeof g!="number"&&typeof g!="boolean")throw new TypeError(`Cannot convert ${Ai(g)} to ${this.name}`);return g},argPackAdvance:kn,readValueFromPointer:zf(a,u),destructorFunction:null})},Vf=(s,a,u,f,g,M,T,C)=>{var U=As(a,u);s=Bt(s),s=ea(s),g=Bn(f,g,T),Jo(s,function(){Ci(`Cannot call ${s} due to unbound types`,U)},a-1),Rn([],U,G=>{var te=[G[0],null].concat(G.slice(1));return Tl(s,Ts(s,te,null,g,M,T),a-1),[]})},Gf=(s,a,u,f,g)=>{a=Bt(a);const M=f===0;let T=U=>U;if(M){var C=32-8*u;T=U=>U<<C>>>C,g=T(g)}xn(s,{name:a,fromWireType:T,toWireType:(U,G)=>{if(typeof G!="number"&&typeof G!="boolean")throw new TypeError(`Cannot convert "${Ai(G)}" to ${a}`);return xl(a,G,f,g),G},argPackAdvance:kn,readValueFromPointer:yl(a,u,f!==0),destructorFunction:null})},Wf=(s,a,u)=>{var f=[Int8Array,Uint8Array,Int16Array,Uint16Array,Int32Array,Uint32Array,Float32Array,Float64Array,BigInt64Array,BigUint64Array],g=f[a];function M(T){var C=Me[T>>2],U=Me[T+4>>2];return new g(oe.buffer,U,C)}u=Bt(u),xn(s,{name:u,fromWireType:M,argPackAdvance:kn,readValueFromPointer:M},{ignoreDuplicateRegistrations:!0})},Xf=Object.assign({optional:!0},Ll),$f=(s,a)=>{xn(s,Xf)},Ri=(s,a,u)=>(L(typeof u=="number","stringToUTF8(str, outPtr, maxBytesToWrite) is missing the third parameter that specifies the length of the output buffer!"),je(s,ve,a,u)),jf=(s,a)=>{a=Bt(a),xn(s,{name:a,fromWireType(u){for(var f=Me[u>>2],g=u+4,M,T,C=g,T=0;T<=f;++T){var U=g+T;if(T==f||ve[U]==0){var G=U-C,te=dt(C,G);M===void 0?M=te:(M+="\0",M+=te),C=U+1}}return Hn(u),M},toWireType(u,f){f instanceof ArrayBuffer&&(f=new Uint8Array(f));var g,M=typeof f=="string";M||ArrayBuffer.isView(f)&&f.BYTES_PER_ELEMENT==1||vt("Cannot pass non-string to std::string"),M?g=Xe(f):g=f.length;var T=ra(4+g+1),C=T+4;return Me[T>>2]=g,M?Ri(f,C,g+1):ve.set(f,C),u!==null&&u.push(Hn,T),T},argPackAdvance:kn,readValueFromPointer:Es,destructorFunction(u){Hn(u)}})},Nl=typeof TextDecoder<"u"?new TextDecoder("utf-16le"):void 0,Yf=(s,a)=>{L(s%2==0,"Pointer passed to UTF16ToString must be aligned to two bytes!");for(var u=s>>1,f=u+a/2,g=u;!(g>=f)&&be[g];)++g;if(g-u>16&&Nl)return Nl.decode(be.subarray(u,g));for(var M="",T=u;!(T>=f);++T){var C=be[T];if(C==0)break;M+=String.fromCharCode(C)}return M},qf=(s,a,u)=>{if(L(a%2==0,"Pointer passed to stringToUTF16 must be aligned to two bytes!"),L(typeof u=="number","stringToUTF16(str, outPtr, maxBytesToWrite) is missing the third parameter that specifies the length of the output buffer!"),u??(u=2147483647),u<2)return 0;u-=2;for(var f=a,g=u<s.length*2?u/2:s.length,M=0;M<g;++M){var T=s.charCodeAt(M);Ue[a>>1]=T,a+=2}return Ue[a>>1]=0,a-f},Zf=s=>s.length*2,Kf=(s,a)=>{L(s%4==0,"Pointer passed to UTF32ToString must be aligned to four bytes!");for(var u="",f=0;!(f>=a/4);f++){var g=pe[s+f*4>>2];if(!g)break;u+=String.fromCodePoint(g)}return u},Jf=(s,a,u)=>{if(L(a%4==0,"Pointer passed to stringToUTF32 must be aligned to four bytes!"),L(typeof u=="number","stringToUTF32(str, outPtr, maxBytesToWrite) is missing the third parameter that specifies the length of the output buffer!"),u??(u=2147483647),u<4)return 0;for(var f=a,g=f+u-4,M=0;M<s.length;++M){var T=s.codePointAt(M);if(T>65535&&M++,pe[a>>2]=T,a+=4,a+4>g)break}return pe[a>>2]=0,a-f},Qf=s=>{for(var a=0,u=0;u<s.length;++u){var f=s.codePointAt(u);f>65535&&u++,a+=4}return a},ep=(s,a,u)=>{u=Bt(u);var f,g,M,T;a===2?(f=Yf,g=qf,T=Zf,M=C=>be[C>>1]):a===4&&(f=Kf,g=Jf,T=Qf,M=C=>Me[C>>2]),xn(s,{name:u,fromWireType:C=>{for(var U=Me[C>>2],G,te=C+4,le=0;le<=U;++le){var ge=C+4+le*a;if(le==U||M(ge)==0){var ue=ge-te,ye=f(te,ue);G===void 0?G=ye:(G+="\0",G+=ye),te=ge+a}}return Hn(C),G},toWireType:(C,U)=>{typeof U!="string"&&vt(`Cannot pass non-string to C++ string type ${u}`);var G=T(U),te=ra(4+G+a);return Me[te>>2]=G/a,g(U,te+4,G+a),C!==null&&C.push(Hn,te),te},argPackAdvance:kn,readValueFromPointer:Es,destructorFunction(C){Hn(C)}})},tp=(s,a)=>{Il(s)},np=(s,a)=>{a=Bt(a),xn(s,{isVoid:!0,name:a,argPackAdvance:0,fromWireType:()=>{},toWireType:(u,f)=>{}})},ip=()=>{throw new k},Fl=(s,a,u)=>{var f=[],g=s.toWireType(f,u);return f.length&&(Me[a>>2]=zt.toHandle(f)),g},rp=(s,a,u)=>(s=zt.toValue(s),a=Cs(a,"emval::as"),Fl(a,u,s)),Rs=[],sp=(s,a,u,f)=>(s=Rs[s],a=zt.toValue(a),s(null,a,u,f)),op={},na=s=>{var a=op[s];return a===void 0?Bt(s):a},ap=(s,a,u,f,g)=>(s=Rs[s],a=zt.toValue(a),u=na(u),s(a,a[u],f,g)),Ul=()=>globalThis,cp=s=>s===0?zt.toHandle(Ul()):(s=na(s),zt.toHandle(Ul()[s])),lp=s=>{var a=Rs.length;return Rs.push(s),a},up=(s,a)=>{for(var u=new Array(s),f=0;f<s;++f)u[f]=Cs(Me[a+f*4>>2],`parameter ${f}`);return u},hp=(s,a,u)=>{var f=up(s,a),g=f.shift();s--;var M=`return function (obj, func, destructorsRef, args) {
...
`)+`
`+v);const P=F+x+c,A=F+v+l,X=eh(r,r.VERTEX_SHADER,P),L=eh(r,r.FRAGMENT_SHADER,A);r.attachShader(b,X),r.attachShader(b,L),t.index0AttributeName!==void 0?r.bindAttribLocation(b,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(b,0,"position"),r.linkProgram(b);function B(k){if(i.debug.checkShaderErrors){const ee=r.getProgramInfoLog(b).trim(),K=r.getShaderInfoLog(X).trim(),J=r.getShaderInfoLog(L).trim();let ie=!0,ne=!0;if(r.getProgramParameter(b,r.LINK_STATUS)===!1)if(ie=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,b,X,L);else{const _e=nh(r,X,"vertex"),se=nh(r,L,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(b,r.VALIDATE_STATUS)+`
