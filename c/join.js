...
import {
  ...
  renderSlide,
  studentId
} from "./session-shared.js?v=20260912a";
...
async function enterWorkshop(pin) {
  ...
  setPinStatus("");
  // Keep /c/join/?pin= — do not replaceState to /NNNN (404 SPA is dark and confusing).
  const joinPath = `/c/join/?pin=${encodeURIComponent(normalizedPin)}`;
